const sampleListings = [
  {
    ...
    category: "beach",
    geometry: { type: "Point", coordinates: [-118.7798, 34.0259] } // Malibu
  },
  {
  ...
  },
  {
    ...
    country: "United States",
    category: "mountains",
    geometry: { type: "Point", coordinates: [-106.8175, 39.1911] } // Aspen
  },
  {
    ...
    country: "Italy",
    category: "retreat",
    geometry: { type: "Point", coordinates: [11.2558, 43.7699] } // Florence
  },
  {
  ...
  },
  {
    ...
    country: "United States",
    category: "retreat",
    geometry: { type: "Point", coordinates: [-120.0430, 39.0968] } // Lake Tahoe
  },
  {
  ...
  },
  {
    ...
    country: "Switzerland",
    category: "mountains",
    geometry: { type: "Point", coordinates: [7.2266, 46.0965] } // Verbier
  },
  {
    ...
    country: "Tanzania",
    category: "retreat",
    geometry: { type: "Point", coordinates: [34.8333, -2.3333] } // Serengeti
  },
  {
    ...
    country: "Netherlands",
    category: "pools",
    geometry: { type: "Point", coordinates: [4.9041, 52.3676] } // Amsterdam
  },
  {
  ...
  },
  {
    ...
    category: "castles",
    geometry: { type: "Point", coordinates: [-4.2026, 57.1200] } // Highlands
  },
  {
  ...
  },
  {
    ...
    country: "United States",
    category: "mountains",
    geometry: { type: "Point", coordinates: [-112.0184, 46.9653] } // Montana
  },
  {
    ...
    country: "Greece",
    category: "pools",
    geometry: { type: "Point", coordinates: [25.3333, 37.4500] } // Mykonos
  },
  {
    ...
    country: "Costa Rica",
    category: "mountains",
    geometry: { type: "Point", coordinates: [-83.7534, 10.0000] } // Costa Rica
  },
  {
    ...
    country: "United States",
    category: "retreat",
    geometry: { type: "Point", coordinates: [-79.9311, 32.7765] } // Charleston
  },
  {
  ...
  },
  {
    ...
    country: "United States",
    category: "lake",
    geometry: { type: "Point", coordinates: [-71.5806, 43.1939] } // New Hampshire
  },
  {
    ...
    country: "Maldives",
    category: "lake",
    geometry: { type: "Point", coordinates: [73.5081, 3.2028] } // Maldives
  },
  {
  ...
  },
  {
    ...
    country: "Costa Rica",
    category: "beach",
    geometry: { type: "Point", coordinates: [-85.6602, 9.7489] } // Costa Rica
  },
];
